    ...
    return (
      <div>
        <nav id="colorlib-main-nav" role="navigation"> {/* nav.js */}
            ...
            <div className="colorlib-table-cell js-fullheight">
                ...
                <div className="col-md-12 text-center">
                    <h1 className="mb-4"><a target="_blank" href="home" className="logo">Mathew Chanda</a></h1>
                    <ul>
                        <li className="active" style={{marginRight : 33}}><a target="_blank" target="_blank" href="home"><span><small>01</small>Home</span></a></li>
        ...
        <div className="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a target="_blank" href="https://github.com/iiradia/PackRanks" style={{backgroundImage: 'url(images/PackRanks.jpg)',backgroundSize:"contain"}} className="image order-2 d-flex justify-content-center align-items-center" data-scrollax=" properties: { translateY: '-30%'}">
            </a>
            ...
            <div className="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a target="_blank" href="https://github.com/VirtualPantry/VirtualPantry" className="image d-flex justify-content-center align-items-center" data-scrollax=" properties: { translateY: '-30%'}">
            ...
            <div className="text">
                ...
                <h2 className="heading"><a target="_blank" href="https://github.com/VirtualPantry/VirtualPantry">Virtual Pantry</a></h2>
                ...
                <p><a target="_blank" href="https://github.com/VirtualPantry/VirtualPantry">View Project in Github</a></p>
            </div>
            </div>
            <div className="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a target="_blank" href="https://techatncsu.github.io/" style={{backgroundImage: 'url(images/WolfSnacks.png)',backgroundSize:"contain" }} className="image order-2 d-flex justify-content-center align-items-center" data-scrollax=" properties: { translateY: '-30%'}">
            </a>
            <div className="text order-1">
            <h4 className="subheading">Food Pantry Web App</h4>
                <h2 className="heading"><a target="_blank" href="https://techatncsu.github.io/">WolfSnacks</a></h2>
                ...
                <p><a target="_blank" href="https://techatncsu.github.io/">Learn more at Tech @ NC State</a></p>
            </div>
            </div>
        </div>
        </div>
